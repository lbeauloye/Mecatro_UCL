...
/* Global variables                                                                                 */
    ...
    void *fpga_LT24_D_addr          = ALT_LWFPGASLVS_ADDR + LT24_D_BASE;
    void *fpga_LT24_RESET_N_addr    = ALT_LWFPGASLVS_ADDR + LT24_RESET_N_BASE;
    void *fpga_LT24_RS_addr         = ALT_LWFPGASLVS_ADDR + LT24_RS_BASE;
    void *fpga_LT24_WR_N_addr       = ALT_LWFPGASLVS_ADDR + LT24_WR_N_BASE;
    void *fpga_LT24_ADC_SPI_addr    = ALT_LWFPGASLVS_ADDR + LT24_ADC_SPI_BASE;
    void *fpga_LT24_ADC_IRQ_N_addr  = ALT_LWFPGASLVS_ADDR + LT24_ADC_IRQ_N_BASE;
    void *fpga_LT24_ADC_BUSY_addr   = ALT_LWFPGASLVS_ADDR + LT24_ADC_BUSY_BASE;
    ...
    extern void *fpga_LT24_D_addr;
    extern void *fpga_LT24_RESET_N_addr;
    extern void *fpga_LT24_RS_addr;
    extern void *fpga_LT24_WR_N_addr;
    extern void *fpga_LT24_ADC_SPI_addr;
    extern void *fpga_LT24_ADC_IRQ_N_addr;
    extern void *fpga_LT24_ADC_BUSY_addr;
