...
MAKE_NAME := Demo40_GCC.make					# For full re-build if I'm modified
...
CFLAGS  += -DOS_MAX_PEND_RQST=512
CFLAGS  += -DSPI_DEBUG=1
CFLAGS  += -DSPI_OPERATION=0x10707
CFLAGS  += -DSPI_ISR_RX_THRS=10
