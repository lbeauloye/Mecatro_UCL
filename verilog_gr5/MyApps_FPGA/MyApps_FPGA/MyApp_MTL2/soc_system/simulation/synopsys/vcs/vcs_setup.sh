...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_1_avalon_st_adapter_error_adapter_0.sv \
  ...
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_4_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_4_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_4_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_4_cmd_demux.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_4_router_001.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_4_router.sv \
  ...
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_rsp_demux.sv \
  ...
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_router_002.sv \
  ...
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_router_002.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_router.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_1_avalon_st_adapter.v \
  ...
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_router_001.sv \
  ...
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_4.v \
  ...
  $QSYS_SIMDIR/submodules/soc_system_alt_vip_vfr_0.vo \
