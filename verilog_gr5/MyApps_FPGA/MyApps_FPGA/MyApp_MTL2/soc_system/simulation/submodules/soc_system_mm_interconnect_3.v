...
module soc_system_mm_interconnect_3 (
	...
	wire  [363:0] rsp_mux_src_data;                                                              // rsp_mux:src_data -> mm_bridge_1_m0_agent:rp_data
	wire          rsp_mux_src_ready;                                                             // mm_bridge_1_m0_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                           // rsp_mux:src_channel -> mm_bridge_1_m0_agent:rp_channel
	...
	wire  [363:0] cmd_mux_src_data;                                                              // cmd_mux:src_data -> hps_0_f2h_sdram0_data_agent:cp_data
	...
	wire  [363:0] mm_bridge_1_m0_agent_cp_data;                                                  // mm_bridge_1_m0_agent:cp_data -> router:sink_data
	...
	wire  [363:0] hps_0_f2h_sdram0_data_agent_rp_data;                                           // hps_0_f2h_sdram0_data_agent:rp_data -> router_002:sink_data
	...
	wire  [363:0] cmd_demux_001_src0_data;                                                       // cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	wire  [363:0] rsp_demux_src1_data;                                                           // rsp_demux:src1_data -> rsp_mux_001:sink0_data
