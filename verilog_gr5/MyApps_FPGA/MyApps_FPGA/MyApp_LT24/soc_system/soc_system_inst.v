	soc_system u0 (
		...
		.lt24_adc_busy_external_connection_export  (<connected-to-lt24_adc_busy_external_connection_export>),  //   lt24_adc_busy_external_connection.export
		.lt24_adc_irq_n_external_connection_export (<connected-to-lt24_adc_irq_n_external_connection_export>), //  lt24_adc_irq_n_external_connection.export
		.lt24_adc_spi_external_MISO                (<connected-to-lt24_adc_spi_external_MISO>),                //               lt24_adc_spi_external.MISO
		.lt24_adc_spi_external_MOSI                (<connected-to-lt24_adc_spi_external_MOSI>),                //                                    .MOSI
		.lt24_adc_spi_external_SCLK                (<connected-to-lt24_adc_spi_external_SCLK>),                //                                    .SCLK
		.lt24_adc_spi_external_SS_n                (<connected-to-lt24_adc_spi_external_SS_n>),                //                                    .SS_n
		.lt24_d_external_connection_export         (<connected-to-lt24_d_external_connection_export>),         //          lt24_d_external_connection.export
		.lt24_reset_n_external_connection_export   (<connected-to-lt24_reset_n_external_connection_export>),   //    lt24_reset_n_external_connection.export
		.lt24_rs_external_connection_export        (<connected-to-lt24_rs_external_connection_export>),        //         lt24_rs_external_connection.export
		.lt24_wr_n_external_connection_export      (<connected-to-lt24_wr_n_external_connection_export>),      //       lt24_wr_n_external_connection.export
