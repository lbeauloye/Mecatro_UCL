...
module soc_system_mm_interconnect_0 (
	...
	wire  [108:0] rsp_mux_src_data;                                                               // rsp_mux:src_data -> alt_vip_vfr_0_avalon_master_agent:rp_data
	...
	wire  [361:0] mm_bridge_1_s0_agent_rf_source_data;                                            // mm_bridge_1_s0_agent:rf_source_data -> mm_bridge_1_s0_agent_rsp_fifo:in_data
	...
	wire  [361:0] mm_bridge_1_s0_agent_rsp_fifo_out_data;                                         // mm_bridge_1_s0_agent_rsp_fifo:out_data -> mm_bridge_1_s0_agent:rf_sink_data
	...
	wire  [257:0] mm_bridge_1_s0_agent_rdata_fifo_src_data;                                       // mm_bridge_1_s0_agent:rdata_fifo_src_data -> mm_bridge_1_s0_agent_rdata_fifo:in_data
	...
	wire  [108:0] alt_vip_vfr_0_avalon_master_agent_cp_data;                                      // alt_vip_vfr_0_avalon_master_agent:cp_data -> router:sink_data
	...
	wire  [360:0] mm_bridge_1_s0_agent_rp_data;                                                   // mm_bridge_1_s0_agent:rp_data -> router_001:sink_data
	...
	wire  [108:0] cmd_mux_src_data;                                                               // cmd_mux:src_data -> mm_bridge_1_s0_cmd_width_adapter:in_data
	...
	wire          mm_bridge_1_s0_cmd_width_adapter_src_valid;                                     // mm_bridge_1_s0_cmd_width_adapter:out_valid -> mm_bridge_1_s0_agent:cp_valid
	wire  [360:0] mm_bridge_1_s0_cmd_width_adapter_src_data;                                      // mm_bridge_1_s0_cmd_width_adapter:out_data -> mm_bridge_1_s0_agent:cp_data
	wire          mm_bridge_1_s0_cmd_width_adapter_src_ready;                                     // mm_bridge_1_s0_agent:cp_ready -> mm_bridge_1_s0_cmd_width_adapter:out_ready
	wire    [0:0] mm_bridge_1_s0_cmd_width_adapter_src_channel;                                   // mm_bridge_1_s0_cmd_width_adapter:out_channel -> mm_bridge_1_s0_agent:cp_channel
	wire          mm_bridge_1_s0_cmd_width_adapter_src_startofpacket;                             // mm_bridge_1_s0_cmd_width_adapter:out_startofpacket -> mm_bridge_1_s0_agent:cp_startofpacket
	wire          mm_bridge_1_s0_cmd_width_adapter_src_endofpacket;                               // mm_bridge_1_s0_cmd_width_adapter:out_endofpacket -> mm_bridge_1_s0_agent:cp_endofpacket
	wire          router_001_src_valid;                                                           // router_001:src_valid -> mm_bridge_1_s0_rsp_width_adapter:in_valid
	wire  [360:0] router_001_src_data;                                                            // router_001:src_data -> mm_bridge_1_s0_rsp_width_adapter:in_data
	...
	wire  [108:0] mm_bridge_1_s0_rsp_width_adapter_src_data;                                      // mm_bridge_1_s0_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [257:0] mm_bridge_1_s0_agent_rdata_fifo_out_data;                                       // mm_bridge_1_s0_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	...
	altera_merlin_slave_agent #(
		.PKT_ORI_BURST_SIZE_H      (360),
		.PKT_ORI_BURST_SIZE_L      (358),
		.PKT_RESPONSE_STATUS_H     (357),
		.PKT_RESPONSE_STATUS_L     (356),
		.PKT_BURST_SIZE_H          (339),
		.PKT_BURST_SIZE_L          (337),
		.PKT_TRANS_LOCK            (324),
		.PKT_BEGIN_BURST           (344),
		.PKT_PROTECTION_H          (351),
		.PKT_PROTECTION_L          (349),
		.PKT_BURSTWRAP_H           (336),
		.PKT_BURSTWRAP_L           (336),
		.PKT_BYTE_CNT_H            (335),
		.PKT_BYTE_CNT_L            (326),
		...
		.cp_ready                (mm_bridge_1_s0_cmd_width_adapter_src_ready),                   //              cp.ready
		.cp_valid                (mm_bridge_1_s0_cmd_width_adapter_src_valid),                   //                .valid
		.cp_data                 (mm_bridge_1_s0_cmd_width_adapter_src_data),                    //                .data
		.cp_startofpacket        (mm_bridge_1_s0_cmd_width_adapter_src_startofpacket),           //                .startofpacket
		.cp_endofpacket          (mm_bridge_1_s0_cmd_width_adapter_src_endofpacket),             //                .endofpacket
		.cp_channel              (mm_bridge_1_s0_cmd_width_adapter_src_channel),                 //                .channel
	...
	altera_merlin_width_adapter #(
		...
		.OUT_PKT_RESPONSE_STATUS_H     (357),
		.OUT_PKT_RESPONSE_STATUS_L     (356),
		.OUT_PKT_TRANS_EXCLUSIVE       (325),
		.OUT_PKT_BURST_TYPE_H          (341),
		.OUT_PKT_BURST_TYPE_L          (340),
		.OUT_PKT_ORI_BURST_SIZE_L      (358),
		.OUT_PKT_ORI_BURST_SIZE_H      (360),
		.OUT_ST_DATA_W                 (361),
		.ST_CHANNEL_W                  (1),
		.OPTIMIZE_FOR_RSP              (0),
		.RESPONSE_PATH                 (0),
	...
	altera_merlin_width_adapter #(
		...
		.IN_PKT_RESPONSE_STATUS_H      (357),
		.IN_PKT_RESPONSE_STATUS_L      (356),
		.IN_PKT_TRANS_EXCLUSIVE        (325),
		.IN_PKT_BURST_TYPE_H           (341),
		.IN_PKT_BURST_TYPE_L           (340),
		.IN_PKT_ORI_BURST_SIZE_L       (358),
		.IN_PKT_ORI_BURST_SIZE_H       (360),
		.IN_ST_DATA_W                  (361),
		.OUT_PKT_ADDR_H                (67),
		.OUT_PKT_ADDR_L                (36),
		.OUT_PKT_DATA_H                (31),
