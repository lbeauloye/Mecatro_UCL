...
else ifeq ($(DEMO_NMB), 100)
  BIN  := ${MyAPP}_SMP_$(BOARD_ID)_A9_GCC.bin
  ELF  := ${MyAPP}_SMP_$(BOARD_ID)_A9_GCC.axf
else ifeq ($(DEMO_NMB), 110)
  BIN  := ${MyAPP}_SMP_$(BOARD_ID)_A9_GCC.bin
  ELF  := ${MyAPP}_SMP_$(BOARD_ID)_A9_GCC.axf
else ifeq ($(DEMO_NMB), 112)
  BIN  := ${MyAPP}_SMP_$(BOARD_ID)_A9_GCC.bin
  ELF  := ${MyAPP}_SMP_$(BOARD_ID)_A9_GCC.axf
else
