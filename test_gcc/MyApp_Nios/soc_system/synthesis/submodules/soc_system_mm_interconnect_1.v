...
module soc_system_mm_interconnect_1 (
	...
	wire    [1:0] rsp_mux_src_channel;                                                                        // rsp_mux:src_channel -> address_span_extender_0_expanded_master_agent:rp_channel
	...
	wire          rsp_mux_001_src_valid;                                                                      // rsp_mux_001:src_valid -> f2sdram_only_master_master_agent:rp_valid
	wire  [108:0] rsp_mux_001_src_data;                                                                       // rsp_mux_001:src_data -> f2sdram_only_master_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                                      // f2sdram_only_master_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                                                    // rsp_mux_001:src_channel -> f2sdram_only_master_master_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                                              // rsp_mux_001:src_startofpacket -> f2sdram_only_master_master_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                                // rsp_mux_001:src_endofpacket -> f2sdram_only_master_master_agent:rp_endofpacket
	...
	wire  [108:0] f2sdram_only_master_master_agent_cp_data;                                                   // f2sdram_only_master_master_agent:cp_data -> router_001:sink_data
