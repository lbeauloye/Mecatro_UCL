	soc_system u0 (
		...
		.dipsw_pio_nios_external_connection_export (<connected-to-dipsw_pio_nios_external_connection_export>), // dipsw_pio_nios_external_connection.export
		...
		.led_pio_nios_external_connection_export   (<connected-to-led_pio_nios_external_connection_export>),   //   led_pio_nios_external_connection.export
		...
		.spi_hps_external_MISO                     (<connected-to-spi_hps_external_MISO>),                     //                   spi_hps_external.MISO
		.spi_hps_external_MOSI                     (<connected-to-spi_hps_external_MOSI>),                     //                                   .MOSI
		.spi_hps_external_SCLK                     (<connected-to-spi_hps_external_SCLK>),                     //                                   .SCLK
		.spi_hps_external_SS_n                     (<connected-to-spi_hps_external_SS_n>),                     //                                   .SS_n
		.spi_nios_external_MISO                    (<connected-to-spi_nios_external_MISO>),                    //                  spi_nios_external.MISO
		.spi_nios_external_MOSI                    (<connected-to-spi_nios_external_MOSI>),                    //                                   .MOSI
		.spi_nios_external_SCLK                    (<connected-to-spi_nios_external_SCLK>),                    //                                   .SCLK
		.spi_nios_external_SS_n                    (<connected-to-spi_nios_external_SS_n>)                     //                                   .SS_n
	);
